...
export function CreatorProfile({ creator }: { creator: CreatorProps }) {
    const PlatformIcon = creator.platform === 'YouTube' ? Youtube : creator.platform === 'TikTok' ? Users : Twitter // Placeholder
                ...
                <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="flex items-center space-x-2 text-sm text-zinc-400 mb-12 overflow-x-auto whitespace-nowrap pb-2">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <Link href="/creators" className="hover:text-white transition-colors">Creator Database</Link>
                        </div>
                        <div className="flex items-center space-x-2">
                            <ChevronRight className="w-4 h-4 text-zinc-600" />
                            <span className="text-cyan-400 font-medium">{creator.name} Net Worth</span>
                        </div>
                    </nav>
                    ...
                    <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start mb-20">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center space-x-6">
                                <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden border-4 border-white/10 shrink-0 bg-white/5 relative">
                                    {/* Using a solid color fallback with initials since we don't have scraped images yet */}
                                ...
                                <div>
                                    ...
                                    <p className="text-xl text-zinc-400">@{creator.handle}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4 pt-4 border-t border-white/10">
                                ...
                                <span className="inline-flex items-center px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm font-medium text-zinc-300">
                                    Niche: <span className="text-white ml-2">{creator.niche}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-cyan-900/40 to-blue-900/20 border border-cyan-500/30 rounded-3xl p-8 relative overflow-hidden ring-1 ring-white/5 shadow-2xl shadow-cyan-900/20">
                            ...
                            <div className="space-y-8 relative z-10">
                                <div>
                                    <p className="text-sm text-zinc-400 mb-2 uppercase tracking-wide font-medium">Monthly Ad Revenue</p>
                                    <p className="text-4xl sm:text-5xl font-bold tracking-tight text-white drop-shadow-sm">
                                        ${creator.estMonthlyEarnings}<span className="text-2xl text-zinc-500 font-normal">/mo</span>
                                    </p>
                                </div>
                                ...
                                <div>
                                    <p className="text-sm text-zinc-400 mb-2 uppercase tracking-wide font-medium">Yearly Run Rate</p>
                                    <p className="text-3xl font-bold tracking-tight text-white">
                                        ${creator.estYearlyEarnings}<span className="text-xl text-zinc-500 font-normal">/yr</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 bg-black/40 rounded-xl p-4 border border-white/5">
                                <p className="text-xs text-zinc-400 text-center leading-relaxed">
                                    Estimates are calculated using Infloura's proprietary {creator.niche} algorithm. Real numbers varying by sponsorships and merch.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 mb-20">
                        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 flex items-center justify-between group hover:bg-white/[0.04] transition-colors">
                            <div>
                                <p className="text-sm font-medium text-zinc-500 uppercase tracking-widest mb-2">Total Followers</p>
                        ...
                        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 flex items-center justify-between group hover:bg-white/[0.04] transition-colors">
                            <div>
                                <p className="text-sm font-medium text-zinc-500 uppercase tracking-widest mb-2">Avg. Views / Video</p>
                    ...
                    <div className="text-center p-12 bg-white/[0.02] border border-white/5 rounded-3xl">
                        <h3 className="text-3xl font-bold text-white mb-4">Want numbers like {creator.name}?</h3>
                        <p className="text-xl text-zinc-400 mb-8 max-w-2xl mx-auto">
                            Calculate your own channel's exact value, forecast your growth, and learn how to price your sponsorships professionally.
                        </p>
