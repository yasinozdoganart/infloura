...
const CpuArchitecture = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* 1st */}
        <path stroke="url(#cpu-blue-grad)" d="M 10 20 h 79.5 q 5 0 5 5 v 30" />
        {/* 2nd */}
        <path stroke="url(#cpu-pinkish-grad)" d="M 180 10 h -69.7 q -5 0 -5 5 v 30" />
        {/* 3rd */}
        <path stroke="url(#cpu-green-grad)" d="M 130 20 v 21.8 q 0 5 -5 5 h -10" />
        {/* 4th */}
        <path stroke="url(#cpu-yellow-grad)" d="M 170 80 v -21.8 q 0 -5 -5 -5 h -50" />
        {/* 5th */}
        <path stroke="url(#cpu-cyan-grad)" d="M 135 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -20" />
        {/* 6th */}
        <path stroke="url(#cpu-orange-grad)" d="M 94.8 95 v -36" />
        {/* 7th */}
        <path stroke="url(#cpu-rose-grad)" d="M 88 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14" />
        {/* 8th */}
        <path stroke="#a855f7" d="M 30 30 h 25 q 5 0 5 5 v 6.5 q 0 5 5 5 h 20" />
      ...
      <g>
        ...
        {showCpuConnections && (
          <g fill="url(#cpu-connection-gradient)">
            {/* Top Pins */}
            <rect x="89" y="34.5" width="2.5" height="5" rx="0.7" />
            <rect x="108.5" y="34.5" width="2.5" height="5" rx="0.7" />
            {/* Bottom Pins */}
            <rect x="89" y="60.5" width="2.5" height="5" rx="0.7" />
            <rect x="108.5" y="60.5" width="2.5" height="5" rx="0.7" />
            {/* Left Pins */}
            <rect x="77" y="43" width="5" height="2.5" rx="0.7" />
            <rect x="77" y="54.5" width="5" height="2.5" rx="0.7" />
            {/* Right Pins */}
            <rect x="118" y="43" width="5" height="2.5" rx="0.7" />
            <rect x="118" y="54.5" width="5" height="2.5" rx="0.7" />
          </g>
        )}
        {/* Main CPU Rectangle */}
        <rect
      ...
      <defs>
        ...
        >
          ...
          >
            {animateMarkers && (
              <animate attributeName="r" values="0.5; 1.5; 1.2" dur="0.5s" />
            )}
          </circle>
        </marker>
