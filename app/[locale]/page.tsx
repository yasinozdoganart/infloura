    ...
    <div className="min-h-screen bg-[#030303] text-white selection:bg-purple-500/30">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-zinc-900/50 border-white/10 text-white backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-xl">{t('feat1Title')}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-zinc-900/50 border-white/10 text-white backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-xl">{t('feat2Title')}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-zinc-900/50 border-white/10 text-white backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-xl">{t('feat3Title')}</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-24 bg-zinc-950 relative z-10 border-t border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-16">{t('howTitle')}</h2>
